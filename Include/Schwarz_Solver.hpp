...
class Schwarz_Solver{
     ...
     */
    static void build_local_matrix(const Grid& grid, Eigen::SparseMatrix<double>& A);
     ...
     */
    static void local_solve(Grid& grid, Eigen::SparseLU<Eigen::SparseMatrix<double>>& solver);
     ...
     * @param BC_func A function that computes the boundary condition value at given coordinates
     */
    static void Solve_Schwarz(Grid &grid, int rank, int size, double tol, int max_iters, double &l2_error,
